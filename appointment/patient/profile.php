...
$res=mysqli_query($con,"UPDATE patient SET patientFirstName='$patientFirstName', patientLastName='$patientLastName',  patientDOB='$patientDOB', patientGender='$patientGender', patientEmail='$patientEmail' WHERE icPatient=".$_SESSION['patientSession']);
