                    ...
                    <div class="modal-body">
                        ...
                        <div class="container" id="wrap">
                            <div class="row">
                              ...
                              <form action="<?php $_PHP_SELF ?>" method="POST" onsubmit="return validate(this)" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <div class="row">
                                            ...
                                            <span style="color: red" id="snameErr"></span>
                                        </div>
                                        ...
                                        <span style="color: red" id="icErr"></span>
                                        ...
                                        <span style="color: red" id="cpassErr1"></span>
                                        ...
                                        <div class="row">
                                            ...
                                            <span style="color: red" id="dobErr"></span>
                                        </div>
                                        <label>Gender : </label>
